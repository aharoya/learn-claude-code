...
1. `Read the file README.md, then read demo_code.py, then read s01_agent_loop/README.md` (read multiple files consecutively, observe L2 compressing old results)
